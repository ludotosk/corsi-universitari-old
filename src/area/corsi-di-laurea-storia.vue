<template>
  <div class="container is-fullhd">
    ...
    <h2 class="has-text-centered is-size-3 has-text-grey has-text-left">
      Dove laurearsi in {{ uni }}? Tutti i corsi di laurea!
    </h2>
    <br />
...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea storia [lista]",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea di storia, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea storia",
      },
    ],
    link: [
      {
  ...
  /*     {
        rel: "preload",
        href:
          "https://json-corsi-fastify.herokuapp.com/corsi?c=L-42&c=LM-89&c=LM-15",
        as: "fetch",
      }, */
    ],
  },
  ...
  /* methods: {
    FiltraLista: function () {
      ...
      for (var x = 0; x < corsi.length; x++) {
        if (corsi[x].c == "L-42" || corsi[x].c == "LM-89" || corsi[x].c == "LM-15") {
          array.push(corsi[x]);
        }
      }
      return array;
