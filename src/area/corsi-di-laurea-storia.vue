...
export default {
  metaInfo: {
    ...
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea storia",
      },
    ],
    link: [
      {
  ...
  async created(){
    try {
      const res = await axios.get('https://json-server-corsi.herokuapp.com/corsi?c=L-42&c=LM-89&c=LM-15');
