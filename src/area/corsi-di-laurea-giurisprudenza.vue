...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea giurisprudenza",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea di giurisprudenza, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea giurisprudenza",
      },
    ],
    link: [
      {
    ...
    /*   {
        rel: "preload",
        href:
          "https://json-server-corsi.herokuapp.com/api/corsi?c=L-14&c=LMG-01&c=LM/SC-GIUR",
        as: "fetch",
      }, */
    ],
  },
  ...
  /*  methods: {
    FiltraLista: function () {
      ...
      for (var x = 0; x < corsi.length; x++) {
        if (corsi[x].c == "L-14" || corsi[x].c == "LMG-01" || corsi[x].c == "LM/SC-GIUR" ) {
          array.push(corsi[x]);
        }
      }
      return array;
