...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea filosofia [lista]",
    ...
    /*   {
        rel: "preload",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?c=L-5&c=LM-78",
        as: "fetch",
      }, */
    ],
  },
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-corsi-fastify.herokuapp.com/corsi?c=L-5&c=LM-78"
      );
