...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea fisioterapia",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea di fisioterapia, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea fisioterapia",
      },
    ],
    link: [
      {
 ...
 /*      {
        rel: "preload",
        href:
          "https://json-server-corsi.herokuapp.com/api/corsi?c=L/SNT2&n=Fisioterapia (abilitante alla professione sanitaria di Fisioterapista)",
        as: "fetch",
      }, */
    ],
  },
  ...
  /* methods: {
    FiltraLista: function () {
      ...
      for (var x = 0; x < corsi.length; x++) {
        if (corsi[x].c == "L/SNT2" && corsi[x].n.slice(0, 12) == "Fisioterapia") {
          array.push(corsi[x]);
        }
      }
      return array;
