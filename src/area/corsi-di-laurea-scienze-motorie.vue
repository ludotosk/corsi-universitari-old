...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea scienze motorie",
    ...
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-scienze-motorie",
      },
    ],
  },
  data() {
    ...
    async created(){
    try {
      const res = await axios.get('https://json-server-corsi.herokuapp.com/corsi?c=L-22&c=LM-67');
