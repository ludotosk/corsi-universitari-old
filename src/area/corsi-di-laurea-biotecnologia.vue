...
export default {
  metaInfo: {
    ...
    /*   {
        rel: "preload",
        href: "https://json-server-corsi.herokuapp.com/api/corsi?c=L-02&c=LM-7&c=LM-8&c=LM-9",
        as: "fetch",
      }, */
    ],
  },
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-server-corsi.herokuapp.com/api/corsi?c=L-02&c=LM-7&c=LM-8&c=LM-9"
      );
