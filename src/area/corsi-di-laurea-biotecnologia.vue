...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea biotecnologia [lista]",
    ...
    /*   {
        rel: "preload",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?c=L-02&c=LM-7&c=LM-8&c=LM-9",
        as: "fetch",
      }, */
    ],
  },
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-corsi-fastify.herokuapp.com/corsi?c=L-02&c=LM-7&c=LM-8&c=LM-9"
      );
