...
export default {
  metaInfo: {
    ...
    meta: [
      ...
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea logopedia",
      },
    ],
    link: [
      {
    ...
    /*   {
        rel: "preload",
        href:
          "https://json-server-corsi.herokuapp.com/api/corsi?c=L/SNT2&n=Logopedia (abilitante alla professione sanitaria di Logopedista)",
        as: "fetch",
      }, */
    ],
  },
