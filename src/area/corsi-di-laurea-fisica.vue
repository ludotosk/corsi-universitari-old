...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea fisica [lista]",
    ...
    meta: [
      ...
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea fisica",
      },
    ],
    link: [
      {
   ...
   /*    {
        rel: "preload",
        href:
          "https://www.corsiuniversitari.info/api/corsi?c=L-30&c=LM-17&c=LM-44&c=LM-79",
        as: "fetch",
      }, */
    ],
  },
