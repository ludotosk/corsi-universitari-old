...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea informatica [2021]",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea di informatica, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea informatica",
      },
    ],
    link: [
      {
      ...
      /*  {
        rel: "preload",
        href:
          "https://www.corsiuniversitari.info/api/corsi?c=L-31&c=LM-18&c=LM-32&c=LM-43&c=LM-66",
        as: "fetch",
      }, */
    ],
  },
