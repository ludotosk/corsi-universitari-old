<template>
  <div class="container is-fullhd">
    ...
    <h2 class="has-text-centered is-size-3 has-text-grey has-text-left">
      Dove studiare {{ uni }} in Italia? Tutti i corsi di laurea!
    </h2>
    <br />
...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea matematica [lista]",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea di matematica, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea matematica",
      },
    ],
    link: [
      {
     ...
     /*  {
        rel: "preload",
        href:
          "https://json-corsi-fastify.herokuapp.com/corsi?c=L-31&LM-40&c=LM-44",
        as: "fetch",
      }, */
    ],
  },
  ...
  /*   methods: {
    FiltraLista: function () {
      ...
      for (var x = 0; x < corsi.length; x++) {
        if (corsi[x].c == "L-35" || corsi[x].c == "LM-40" || corsi[x].c == "LM-44") {
          array.push(corsi[x]);
        }
      }
      return array;
