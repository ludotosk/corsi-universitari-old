...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea matematica",
    ...
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea matematica",
      },
    ],
    link: [
      {
  ...
  data() {
   ...
   async created(){
    try {
      const res = await axios.get('https://json-server-corsi.herokuapp.com/corsi?c=L-31&LM-40&c=LM-44');
