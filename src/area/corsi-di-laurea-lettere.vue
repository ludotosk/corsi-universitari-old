...
export default {
  metaInfo: {
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea di lettere, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea lettere",
      },
    ],
    link: [
      {
   ...
   /*    {
        rel: "preload",
        href:
          "https://json-server-corsi.herokuapp.com/api/corsi?L-10&c=LM-15&LM-36&LM-37",
        as: "fetch",
      }, */
    ],
  },
  ...
  /*  methods: {
    FiltraLista: function () {
      ...
      for (var x = 0; x < corsi.length; x++) {
        if (corsi[x].c == "L-10" || corsi[x].c == "LM-15" || corsi[x].c == "LM-36" || corsi[x].c == "LM-37") {
          array.push(corsi[x]);
        }
      }
      return array;
