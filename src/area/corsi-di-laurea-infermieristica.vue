...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea infermieristica",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea di infermieristica, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea infermieristica",
      },
    ],
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-infermieristica",
      },
    ],
  },
  data() {
  ...
  methods: {
    FiltraLista: function () {
      ...
      for (var x = 0; x < corsi.length; x++) {
        if (corsi[x].c == "L/SNT1" && corsi[x].n.slice(0, 15) == "Infermieristica") {
          array.push(corsi[x]);
        }
      }
      return array;
