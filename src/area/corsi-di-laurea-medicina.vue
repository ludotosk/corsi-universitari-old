...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea medicina",
...
/*       {
        rel: "preload",
        href: "https://json-server-corsi.herokuapp.com/api/corsi?c=LM-41&c=LM-42",
        as: "fetch",
      }, */
    ],
  },
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-server-corsi.herokuapp.com/api/corsi?c=LM-41&c=LM-42"
      );
