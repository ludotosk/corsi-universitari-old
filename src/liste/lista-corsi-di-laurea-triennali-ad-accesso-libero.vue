...
<!--       <router-link
    ...
    <p>
      Qui si può trovare <strong>la lista dei corsi di laurea triennali ad accesso libero</strong>. I
  ...
  metaInfo: {
    ...
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Lista corsi di laurea ad accesso libero",
      },
    ],
    link: [
      {
