<template>
  <div class="container is-fullhd">
   ...
   <h1 class="has-text-centered is-size-2 has-text-grey has-text-left">
      Lista corsi di laurea senza test d'ingresso
    </h1>
    <br />
    <h2 class="has-text-grey is-size-2">
      Qui puoi trovare la lista dei corsi di laurea senza test d'ingresso
    </h2>
    <hr />
    <p>
      ...
      <router-link to="/corsi-di-laurea-senza-test" class="has-text-danger"> visita questa pagina</router-link>.
    </p>
    <p>
      Qui si possono trovare
      <strong>tutti i corsi di laurea senza test d'ingresso</strong>. I corsi
...
export default {
  metaInfo: {
    ...
    title: "Lista corsi di laurea senza test d'ingresso",
    ...
    meta: [
      ...
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Lista corsi di laurea senza test d'ingresso'",
      },
    ],
    link: [
      {
