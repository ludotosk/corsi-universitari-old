<template>
  <div class="container is-fullhd">
    ...
    <h2 class="has-text-centered is-size-3 has-text-dark has-text-left">
      Quali corsi di laurea ci sono a {{uni}}? [aggiornato 2021]
    </h2>
    <br />
...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea Federico II [2021]",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea federico II, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea federico II",
      },
    ],
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-federico-ii",
      },
    ],
  },
  data() {
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        'https://json-corsi-fastify.herokuapp.com/corsi?u=Università degli Studi di NAPOLI "Federico II"'
      );
