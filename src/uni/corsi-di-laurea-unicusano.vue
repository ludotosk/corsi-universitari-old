...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea Unicusano",
    ...
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea unicusano",
      },
    ],
    link: [
      {
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        'https://json-server-corsi.herokuapp.com/api/corsi?u=UNICUSANO Università degli Studi Niccolò Cusano -Telematica Roma'
      );
