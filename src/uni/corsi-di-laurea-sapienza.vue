...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea Sapienza",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea la sapienza, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea sapienza",
      },
    ],
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-sapienza",
      },
    ],
  },
  data() {
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        'https://json-server-corsi.herokuapp.com/api/corsi?u=Università degli Studi di ROMA "La Sapienza"'
      );
