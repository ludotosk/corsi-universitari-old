<template>
  <div class="container is-fullhd">
    <br />
      <h1 class="has-text-centered is-size-2 has-text-dark has-text-left">Corsi di laurea {{uni}} [Milano]</h1>
...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea Bocconi [Milano]",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea bocconi, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea bocconi",
      },
    ],
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-bocconi",
      },
    ],
  },
  data() {
...
/*   methods: {
    FiltraLista: function () {
      ...
      for (var x = 0; x < corsi.length; x++) {
        if (corsi[x].u == "Università Commerciale \"Luigi Bocconi\" MILANO") {
          array.push(corsi[x]);
        }
      }
      return array;
