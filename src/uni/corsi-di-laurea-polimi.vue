<template>
  <div class="container is-fullhd">
    ...
    <h2 class="has-text-centered is-size-3 has-text-dark has-text-left">
      Cosa si studia al {{ uni }}? Tutti i corsi di laurea!
    </h2>
    <!--     <hr />
    <p>
...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea Polimi [lista]",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea Polimi, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea polimi",
      },
    ],
    link: [
      {
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-corsi-fastify.herokuapp.com/corsi?u=Politecnico di MILANO"
      );
