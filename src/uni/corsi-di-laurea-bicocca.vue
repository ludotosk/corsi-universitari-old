<template>
  <div class="container is-fullhd">
    ...
    <h2 class="has-text-centered is-size-3 has-text-grey has-text-left">
      Quali sono le lauree alla {{ uni }}? [con tutte le facoltà]
    </h2>
    <hr />
    <p>
...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea Bicocca [2021]",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea Bicocca, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea bicocca",
      },
    ],
    link: [
      {
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-corsi-fastify.herokuapp.com/corsi?u=Università degli Studi di MILANO-BICOCCA"
      );
