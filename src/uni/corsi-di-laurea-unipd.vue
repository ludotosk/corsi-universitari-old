<template>
  <div class="container is-fullhd">
    ...
    <h2 class="has-text-centered is-size-3 has-text-dark has-text-left">
      Quali corsi di laurea {{ uni }} scegliere? Ecco la lista! [aggiornato
      2021]
    </h2>
    <br />
...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea Unipd [2021]",
    ...
    meta: [
      ...
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea unipd",
      },
    ],
    link: [
      {
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-corsi-fastify.herokuapp.com/corsi?u=Università degli Studi di PADOVA"
      );
