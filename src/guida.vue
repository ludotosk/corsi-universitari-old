<template>
  <div class="container is-fullhd" data-view>
    <br />
   <h1 class="has-text-centered is-size-2 has-text-dark has-text-left">Guida all'utilizzo del sito</h1>
    ...
    <div class="embed-responsive embed-responsive-16by9">
      <iframe
        ...
        src="https://www.youtube.com/embed/ZOE7AzL7ncs"
...
export default {
  metaInfo: {
    ...
    link: [{ rel: "canonical", href: "https://www.corsiuniversitari.info/guida" }],
  },
};
</script>