...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea triennale",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea triennale, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
    ...
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-triennale",
      },
    ],
  },
  data() {
   ...
   async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-server-corsi.herokuapp.com/api/corsi?t=Triennale&_sort=a,u&_order=desc,asc",
      );
