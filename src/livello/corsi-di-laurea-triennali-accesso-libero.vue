...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea triennali ad accesso libero",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea triennali ad accesso libero, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
    ...
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-triennali-ad-accesso-libero",
      },
    ],
  },
  data() {
    return {
      ...
      currentPage: 1,
      totalPages: 0,
      uni: "triennali ad accesso libero",
      corsi: []
    };
  },
   async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-server-corsi.herokuapp.com/api/corsi?t=Triennale&a=No&_sort=u&_order=asc",
      );
