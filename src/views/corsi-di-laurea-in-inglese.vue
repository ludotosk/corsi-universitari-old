...
export default {
  metaInfo: {
    ...
    title: "Università in inglese, corsi di laurea [2021/2022]",
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente l'elenco dei corsi di laurea in inglese, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content: "elenco corsi di laurea inglese",
      },
    ],
    link: [
      {
      ...
      },
      {
        rel: "preload",
        as: "fetch",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?e=1",
