...
export default {
  metaInfo: {
    ...
    title: "Università a Palermo, Corsi di laurea [2021/2022]",
    meta: [
      {
        name: "description",
        content:
    ...
    link: [
      ...
      },
      {
        rel: "preload",
        as: "fetch",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?s=PALERMO",
  ...
  async mounted() {
    try {
      fetch("https://json-corsi-fastify.herokuapp.com/corsi?s=PALERMO")
