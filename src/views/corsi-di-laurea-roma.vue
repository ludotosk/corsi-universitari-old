...
export default {
  metaInfo: {
    ...
    title: "Università a Roma, Corsi di laurea [2021/2022]",
    meta: [
      {
        name: "description",
        content:
      ...
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea roma",
      },
    ],
    link: [
      {
      ...
      },
      {
        rel: "preload",
        as: "fetch",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?s=ROMA",
  ...
  async mounted() {
    try {
      fetch("https://json-corsi-fastify.herokuapp.com/corsi?s=ROMA")
