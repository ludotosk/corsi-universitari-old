...
export default {
  metaInfo: {
    ...
    title: "Università a Bari, Corsi di laurea [2021/2022] ✅",
    meta: [
      {
        name: "description",
        content:
    ...
    link: [
      ...
      },
      {
        rel: "preload",
        as: "fetch",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?s=BARI",
  ...
  async mounted() {
    try {
      fetch("https://json-corsi-fastify.herokuapp.com/corsi?s=BARI")
