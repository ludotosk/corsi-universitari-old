...
export default {
  metaInfo: {
    ...
    link: [
      ...
      },
      {
        rel: "preload",
        as: "fetch",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?t=Magistrale a Ciclo Unico",
  ...
  async mounted() {
    try {
      fetch("https://json-corsi-fastify.herokuapp.com/corsi?t=Magistrale a Ciclo Unico")
