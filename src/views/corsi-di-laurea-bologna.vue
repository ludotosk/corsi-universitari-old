...
export default {
  metaInfo: {
    ...
    title: "Università a Bologna, Corsi di laurea [2021/2022] ✅",
    meta: [
      {
        name: "description",
        content:
      ...
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea Bologna",
      },
    ],
    link: [
      {
      ...
      },
      {
        rel: "preload",
        as: "fetch",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?s=BOLOGNA",
  ...
  async mounted() {
    try {
      fetch("https://json-corsi-fastify.herokuapp.com/corsi?s=BOLOGNA")
