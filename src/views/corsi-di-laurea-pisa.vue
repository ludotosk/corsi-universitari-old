...
export default {
  metaInfo: {
    ...
    meta: [
      ...
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea pisa",
      },
    ],
    link: [
      {
      ...
      },
      {
        rel: "preload",
        as: "fetch",
        href: "https://json-corsi-fastify.herokuapp.com/corsi?s=PISA",
  ...
  async mounted() {
    try {
      fetch("https://json-corsi-fastify.herokuapp.com/corsi?s=PISA")
