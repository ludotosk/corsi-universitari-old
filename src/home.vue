    ...
    meta: [
      {
        name: "description",
        content:
          "corsiuniversitari.info ti permette di cercare fra tutti i corsi universitari italiani in base al nome del corso e di trovare quello che fa per te. Puoi fare un rapido confronto tra corsi, o trovare quante università forniscono lo stesso corso. Così cercheremo ad aiutarti a trovare i migliori corsi universitarii.",
      },
    ],
  },
  data() {
