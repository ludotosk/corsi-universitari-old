...
export default {
  metaInfo: {
    ...
    title: "Master di Secondo Livello",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti master di Secondo livello, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://www.corsiuniversitari.info/api/master?tipo=Master di Secondo Livello&_sort=corso,uni&_order=asc,asc"
      );
