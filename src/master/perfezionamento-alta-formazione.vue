<template>
  <div class="container is-fullhd">
    <br />
   <h1 class="has-text-centered is-size-2 has-text-dark has-text-left">Corsi di Perfezionamento - Alta Formazione</h1>
   <h2 class="has-text-centered is-size-3 has-text-dark has-text-left">Qui puoi trovare tutti i corsi di Perfezionamento - Alta Formazione</h2>
    <br />
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://www.corsiuniversitari.info/api/master?tipo=Corso%20di%20Perfezionamento/Alta%20Formazione&_sort=corso,uni&_order=asc,asc"
      );
