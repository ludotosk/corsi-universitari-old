<template>
  <div class="container-md">
    <br />
    <h1 class="text-secondary">Corsi di Perfezionamento - Alta Formazione</h1>
    <br />
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://json-server-corsi.herokuapp.com/api/master?tipo=Corso%20di%20Perfezionamento/Alta%20Formazione&_sort=corso,uni&_order=asc,asc"
      );
