...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea a Firenze",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea Firenze, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea Firenze",
      },
    ],
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-firenze",
      },
    ],
  },
  data() {
   ...
   async beforeCreate(){
    try {
      const res = await axios.get('https://json-server-corsi.herokuapp.com/api/corsi?s=FIRENZE');
