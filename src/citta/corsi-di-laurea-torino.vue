...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea a Torino [lista]",
    ...
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "Corsi di laurea, Corso di laurea, Corsi di laurea torino",
      },
    ],
    link: [
      {
  ...
  data() {
    ...
    async beforeCreate(){
    try {
      const res = await axios.get('https://json-corsi-fastify.herokuapp.com/corsi?s=TORINO');
