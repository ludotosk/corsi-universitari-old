...
export default {
  metaInfo: {
    ...
    title: "Università a Padova, Corsi di laurea [2021]",
    meta: [
      {
        name: "description",
        content:
      ...
      {
        name: "keywords",
        content: "Corsi di laurea, Corso di laurea, Corsi di laurea padova",
      },
    ],
    link: [
      {
  ...
  async beforeCreate() {
    try {
      const res = await axios.get(
        "https://www.corsiuniversitari.info/api/corsi?s=PADOVA"
      );
