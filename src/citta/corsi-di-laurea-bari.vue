<template>
  <div class="container is-fullhd">
    <br />
     <h1 class="has-text-centered is-size-2 has-text-grey has-text-left">Corsi di laurea a {{uni}} [tutte le facoltà]</h1>
   <h2 class="has-text-centered is-size-3 has-text-grey has-text-left">Quali corsi di laurea ci sono a {{uni}}? Ecco la lista!</h2>
    <br />
...
export default {
  metaInfo: {
    ...
    title: "Corsi di laurea a Bari [tutte le facoltà]",
    ...
    meta: [
      {
        name: "description",
        content:
          "In questo sito potrai trovare rapidamente tutti i corsi di laurea Bari, tutti raggruppati su una comoda tabella.",
      },
      {
        name: "keywords",
        content:
    ...
    link: [
      {
        rel: "canonical",
        href: "https://www.corsiuniversitari.info/corsi-di-laurea-bari",
      },
    ],
  },
  data() {
